...
If the question don't feels incomplete see if you can find the context in: {history} for the question.

---
Answer with the context found in {context} for the question.


If the contexts not make sense or are not relevant, you can answer that you don't know.
---
...
Please provide a concise and accurate response, but if conceptual provide detailed overview with equations, diagrams, and examples etc.

If you have relevent information, please provide the informations and ask them if the user would like to know.
